...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('images/banner1.jpg');">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <p>Medsi24x7, is brought to you by the Medsi Company – one of India’s
              most trusted pharmacies, with over 100 years’ experience in dispensing quality medicines.
              At Medsi, we help you look after your own health effortlessly as well as take care
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img src="images/banner2.jpg" alt="Image placeholder" class="img-fluid rounded">
              </figure>
            </div>
          </div>
          <div class="col-md-5 mr-auto">
            ...
            <p class="text-black">Medsi24x7 continues a legacy of 100 years of success in the
