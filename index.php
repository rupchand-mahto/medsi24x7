...
<body>
  ...
  <div class="site-wrap">
    ...
    ?>
    <div class="site-blocks-cover" style="background-image: url('images/banner1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <h2 class="sub-title">Your prescription to a healthier life.</h2>
              <h1>Welcome To Medsi24x7</h1>
              <p>
            ...
            <div class="nonloop-block-3 no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;Medsi24x7 provided a magnificent service in COVID. It gives good discounts than
                ...
                <p>&mdash; Akhilesh Kumar</p>
              </div>

              <div class="testimony">
                <blockquote>
                  <img src="images/person_2.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                  <p>&ldquo;The selection of products in Medsi is so impressive, and I appreciate the convenience of being 
                    able to order online and have my medications delivered directly to my door. The prices are competitive 
                    and I feel confident knowing that I am getting quality products that have been vetted by the knowledgeable staff..&rdquo;</p>
                </blockquote>

                <p>&mdash; Sunil Pandey</p>
              </div>

              <div class="testimony">
                <blockquote>
                  <img src="images/person_3.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                  <p>&ldquo;Now I became customer of Medsi24x7. Every time I ordering the medicine on Medsi24x7
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;I would like to thanks Medsi for their brilliant Customer Service. I ordered
                    medicines from it and they delivered my medicines within 3 days. Keep it up the
                    good work. Medsi is the best medicine website. I recommend everyone to use Medsi24x7
                    Website.&rdquo;</p>
                </blockquote>
